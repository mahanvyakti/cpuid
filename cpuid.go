...
var vendorMapping = map[string]VendorDetails{
	...
	"Vortex86 SoC": {SiS, "DM&P Vortex86"},
	"SiS SiS SiS ": {SiS, "SiS"},
	"RiseRiseRise": {SiS, "Rise"},
	"Genuine  RDC": {RDC, "RDC Semiconductor Co. Ltd."},
}
...
func vendorID() (Vendor, string) {
	...
	var v string //VendorString
	if false == CPU.VM() {
		_, b, c, d := cpuid(0)
		v = string(valAsString(b, d, c))
		venDetails, ok = vendorMapping[v]
		if !ok {
